      ...
      const mockNotifications = [
        {
          ...
          message: 'Hoạt động tình nguyện cuối tuần đã được tạo thành công',
          type: 'success',
          isRead: false,
        ...
        },
        {
          ...
          message: 'Đã điểm danh 45/50 sinh viên cho hoạt động hôm nay',
          type: 'info',
          isRead: true,
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center mt-1">
                          <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${isDarkMode ? 'bg-green-500/20 text-green-400' : 'bg-green-100 text-green-700'}`}>
